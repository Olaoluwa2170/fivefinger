                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input type="email" placeholder="joe@mail.com" {...field} />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem className="flex justify-between relative">
                            ...
                            <button onClick={toggleShowPassword} className="h-full mr-5 pt-6 absolute md:w-5 w-4 cursor-pointer right-0 pb-3" type="button">
                                {showPassword ? <EyeOffIcon className="text-slate-400"/> : <Eye />}
                            </button>
                        </FormItem>
                      )}
                    />
